...
export const sendSubmissionAccepted = async (
    ...
    rawData: {
        ...
        conference: {
            ...
            site_url: string;
            email: string;
            presentation_confirmation_deadline: Date;
    ...
    const confirmationDeadline =
        rawData.conference.presentation_confirmation_deadline;
    ...
    let data = {
        ...
        conference: {
            ...rawData.conference,
            presentation_confirmation_deadline: `${confirmationDeadline.toLocaleDateString("en-US", { month: "long", day: "numeric" })}, ${confirmationDeadline.getFullYear()}, ${confirmationDeadline.toLocaleTimeString("en-US", { hour12: false, hour: "2-digit", minute: "2-digit" })}`,
